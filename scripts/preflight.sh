...
PYTHONPATH="${PROJECT_DIR}" python3 -m h3ntun check --config "${CONFIG_FILE}"
PYTHONPATH="${PROJECT_DIR}" python3 -m h3ntun doctor --config "${CONFIG_FILE}"
...
import socket
import sys
from h3ntun.config import IranConfig, load_config

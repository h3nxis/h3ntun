...
class Metrics:
    def __init__(self, role: str, metrics_file: str):
        ...
        self.data: dict[str, Any] = {
            ...
            "replay_checkpoint_queue_depth": 0,
            "replay_checkpoint_inflight": 0,
            "replay_checkpoint_lag_frames": 0,
            "replay_checkpoint_lag_ms": 0.0,
            "replay_write_latency_ms": None,
            "replay_persistence_errors": 0,
            "replay_checkpoints": 0,
            "replay_snapshots_coalesced": 0,
            "replay_persistence_last_error": None,
